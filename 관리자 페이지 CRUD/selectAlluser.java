...
public class selectAlluser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 try {
			String sql = "select ID,PWD,MOBILE,NAME,EMAIL from signup";
			...
			while(rs.next()) {
				...
				jo.put("PWD",rs.getString("PWD"));
				jo.put("MOBILE",rs.getString("MOBILE"));//json object 만들기//
				...
				System.out.println(rs.getString("ID")+","+rs.getString("PWD")+","+rs.getString("MOBILE")+","+rs.getString("NAME")+","+rs.getString("EMAIL"));
